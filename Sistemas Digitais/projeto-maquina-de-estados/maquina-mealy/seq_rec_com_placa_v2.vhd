-- Sequence Recognizer: VHDL Mealy Machine
library ieee;
...
begin
   ...
   -- Registrador de estado (reset assíncrono e clock em KEY(0))
   ...
   -- Função de saída (Mealy): Z depende do estado e da entrada
   ...
   -- LEDR indica o estado atual (A–D)
   ...
   -- HEX0 mostra a letra do estado atual
   with state select
      HEX0(6 downto 0) <=
         "0001000" when A,  -- A
         "0000011" when B,  -- b
